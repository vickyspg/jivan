    ...
    <div class="container">
        <div class="row">
            <div class="title-text">
                <h2 class="fs30 ptb50 text-c">Contact Us</h2>
            </div>
            <div class="col-sm-4 contact-area firsrt text-c">
              <img src="images/contact/img1.png" class="img-responsive m0a">  
              <h5 class="fs20 ma pb10 text-u pt20">n.j.infra project pvt ltd</h5>
              <p>Jivan Arya Residency,200 ft Sardar Patel Ring Road,<br>Opp. R.A.F. Camp,Opp. Canara Bank,<br>
              Vastral,Ahmedabad - 382418</p>
            </div>
            <div class="col-sm-4 contact-area second text-c">
              <img src="images/contact/img2.png" class="img-responsive m0a">  
              <h5 class="fs20 ma pb10 text-u pt20">contact number</h5>
              <p><a class="color-b" href="tel:+91 982 503 5749">+91 982 503 5749</a></p>
            </div>
            <div class="col-sm-4 contact-area third text-c">
              <img src="images/contact/img3.png" class="img-responsive m0a">  
              <h5 class="fs20 ma pb10 text-u pt20">n.r.i inquiry</h5>
              <p><b>Contact Person :</b> Mr Ripal Patel (U.S.A)</p>
              <p><b>Contact Number :</b><a class="color-b" href="tel:+001 201 895 34 91"> +001 201 895 34 91</a></p>
              <p><b>Email Id :</b><a class="color-b" href="mailto:ripal@jivangroup.in"> ripal@jivangroup.in</a></p>
            </div>
        </div>
        <div class="pt80 text-c">
            <p style="font-weight:bold;">You can always contact us on <a class="colorbl" href="mailto:inquiry@jivangroup.in">inquiry@jivangroup.in</a> or <a class="colorbl" href="mailto:nj@jivangroup.in">nj@jivangroup.in</a></p>
        </div>
    </div>
</section>
