...
<section class="project-area-home about-main bg-gray pb50">
    <div class="container">
        <div class="row">
            <div class="title-text">
                <h2 class="fs30 ptb50 text-c">about us</h2>
            </div>
            <div class="col-sm-4 about image text-c">
                <img src="images/about/img1.png" class="img-responsive m0a">
                <span class="colorbl pt30 clearfix">Narendra J. Patel CEO - Jivan Group</span>
            </div>
            <div class="col-sm-8 about text text-j">
                <p>Jivan Group has applied its uncompromising commitment to quality in building the residential and commercial properties and we have consistently exceeded expectations and delivered distinctive projects on time and on budget.
                Since our inception in 1983 Jivan Group has believed in, and has constantly striven to repay its moral debt to society. We believe in working towards making a difference to society by providing services that will uplift the standard of living and cover basic human needs.</p>
                <p>Jivan Group has already developed various residential and commercial real estate and handed over to the buyers and respective societies. The properties are highly diversified in terms of usage, design and geography ranging from high-rise to garden styles.The company is well known for adoption of modern and innovative ideas in development. Thousands of occupants of the Jivan Group properties bear testimony to the quality and timeliness of its projects.Jivan Group has highly experienced administrative staff and construction crew. Each of the suppliers and sub-contractors are carefully chosen for the quality of their work and materials. All the fixtures and fittings used by the company in its prestigious projects are taken from the renowned brands, well known for quality and aesthetics. Instilled with every person associated with your home is the Director's personal motto: Build each home as if it was your very own. </p>
            </div>
        </div>
    </div>
</section>
