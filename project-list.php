...
<head>
    ...
    <script type='text/javascript' src='js/wp-embed.min.js?ver=4.7.6'></script>
           ...
           <div id="wrapper">
                ...
                <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
                    <ul class="nav sidebar-nav">                
                        ...
                        <li><a class="active" href="project-list.php">Project</a></li>
...
<section class="project-area-home bg-gray pb50">
    <div class="container">
        <div class="row">
            ...
            <div class="project-home clearfix">
                <div class="col-sm-6 col-xs-12 project-image" style="background-image: url(./images/home/banner/7.png);">  
                </div>
                <div class="col-sm-6 col-xs-12 project-content text-c ptb76 bg-white">
            ...
            <div class="project-home mtb30 clearfix">
                <div class="col-sm-6 col-xs-12 project-image ipad" style="background-image: url(./images/home/banner/9.png);"> 
                </div>
                <div class="col-sm-6 col-xs-12 project-content text-c ptb76 bg-white">
                ...
                <div class="col-sm-6 col-xs-12 project-image desktop" style="background-image: url(./images/home/shubh-jivan-project-image.png);">  
                </div>
            </div>
            <div class="project-home clearfix">
                <div class="col-sm-6 col-xs-12 project-image" style="background-image: url(./images/home/banner/2.png);">   
                </div>
                <div class="col-sm-6 col-xs-12 project-content text-c ptb76 bg-white">
...
<script  type="text/javascript">
    ...
    jQuery(document).ready(function() {    
         // initiate layout and pluginsRICS REGISTERED VALUERS
